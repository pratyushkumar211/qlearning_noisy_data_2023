...
from linsystools import get_optSPKLam_sfeed, ModelFreeController
from linsystools import get_augmats_rocpenalty_sfeed, do_clsims_controllerevals
...
def main():
    ...
    (errS, errK, errLam, 
     estTimes, estK_list) = doLSPI_varyingDataSize_sfeed(zSeq, uSeq, K0, NumIter,
                                            ...
                                            lamOpt, Qw=None, 
                                            algorithm='unknownQw_modifiedLSPI')
    ...
    for Khat in estK_list:
        ...
        # Save the simulated closed-loop data to the list.
    ...
    PickleTool.save(hvac_sfeed_lspi_kqw, 'hvac_sfeed_lspi_uqw.pickle')
